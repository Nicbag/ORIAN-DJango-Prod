...
class AutomatedStrategy:
    ...
    def __init__(
        ...
        self._transaction_trigger = transaction_trigger
        self._buy_transaction_quantity_manager = buy_transaction_quantity_manager
        self._sell_transaction_quantity_manager = sell_transaction_quantity_manager
    ...
    def make_transaction(
        ...
        transaction_type = self._transaction_trigger.evaluate_predictions(
            self.predictions
        )
        ...
        if transaction_type is TransactionEnum.BUY:
            transaction_dto = (
                self._buy_transaction_quantity_manager.compute_asset_amount(
                    transaction_dto
                )
            )
        elif transaction_type is TransactionEnum.SELL:
            transaction_dto = (
                self._sell_transaction_quantity_manager.compute_asset_amount(
                    transaction_dto
                )
            )
